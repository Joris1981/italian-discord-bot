...
class Quiz(commands.Cog):
    def __init__(self, bot):
        ...
        # PRONOMI
        self.pronomi_zinnen = [
            {"zin": "Hai telefonato a Maria? No, non ___ ho ancora telefonto", "antwoord": "le"},
            {"zin": "Puoi chiamare il medico e prendere un appuntamento per domani? Si certo, ___ chiamo tra un secondo.", "antwoord": "lo"},
            {"zin": "Devi portare i libri a tua zia? Si, ___ porto io.", "antwoord": "le"},
            {"zin": "Ho preso una pizza e ___ ho mangiata tutta.", "antwoord": "l'"},
            {"zin": "Hai visto il film che ti ho consigliato? Si, ___ ho visto ieri, ma non mi è piaciuto molto.", "antwoord": "l'"},
            {"zin": "Non riesco a trovare le chiavi! ___ sto cercando da due ore!", "antwoord": "le"},
            {"zin": "Hai ascoltato la nuova canzone di Taylor Swift? Si, ___ sto ascoltando da due ore!", "antwoord": "la"},
            {"zin": "Luca e Paolo ___ hanno invitato a casa loro. Andiamo?", "antwoord": "ci"},
            {"zin": "Ho provato a chiamare Marianna ma non ___ ha risposto.", "antwoord": "mi"},
            {"zin": "Stavi parlando con Roberto? Si, ___ stavo chiedendo un favore", "antwoord": "gli"},
            {"zin": "Ho comprato i pasticcini. ___ porto io alla festa.", "antwoord": "li"},       
            {"zin": "Dove sono i tuoi amici? Non so, ___ sto aspettando da 5 minuti.", "antwoord": "li"},
            {"zin": "Il cane porta la palla al suo padrone. Il cane ___ porta la palla.", "antwoord": "gli"},
            {"zin": "I miei zii hanno regalato una vacanza ai miei cugini. I miei zii ___ hanno regalato una vacanza.", "antwoord": "gli"},
            {"zin": "Vai da Carlo, ___ serve una mano a portare i pacchi!", "antwoord": "gli"},
            {"zin": "Hai visto il gatto di Sara? No, non ___ ho visto.", "antwoord": "lo"},
            {"zin": "Hai comprato le uova? Si, ___ ho comprate al mercato.", "antwoord": "le"},
            {"zin": "Hai scritto il messaggio a Marco? Si, ___ l'ho scritto ieri sera.", "antwoord": "gli"},
            {"zin": "Hai comprato il biglietto per il concerto? Si, ___ ho comprato online.", "antwoord": "l'"},
            {"zin": "Hai già fatto i compiti? Si, ___ ho fatti ieri sera.", "antwoord": "li"}
        ]
        ...
        self.diminutivi_zinnen = [
            {"zin": "Dopo il pranzo, ho preso un piccolo caffè. Era un ___. (caffè)", "antwoord": "caffettino", "type": ":arrow_down:"},
            {"zin": "Quando ero bambino avevo una piccola casa in campagna, una ___. (casa)", "antwoord": "casetta", "type": ":arrow_down:"},
            {"zin": "Hai portato un regalo enorme! È davvero un ___. (regalo)", "antwoord": "regalone", "type": ":arrow_up:"},
            {"zin": "Mi ha scritto un pensiero molto dolce, un ___. (pensiero)", "antwoord": "pensierino", "type": ":arrow_down:"},
            {"zin": "Quando ci siamo visti, mi ha dato un piccolo bacio, un ___. (bacio)", "antwoord": "bacetto", "type": ":arrow_down:"},
            {"zin": "Sul balcone ho messo un piccolo vaso con fiori, un ___. (vaso)", "antwoord": "vasetto", "type": ":arrow_down:"},
            {"zin": "In montagna abbiamo visto un grande albero, un ___. (albero)", "antwoord": "alberone", "type": ":arrow_up:"},
            {"zin": "Mia sorella da piccola era proprio una ___. (sorella)", "antwoord": "sorellina", "type": ":arrow_down:"},
            {"zin": "Da piccolo ero un ___ molto timido. (fratello)", "antwoord": "fratellino", "type": ":arrow_down:"},
            {"zin": "Oggi ho avuto una giornata davvero orribile, una ___. (giornata)", "antwoord": "giornataccia", "type": ":arrow_up:"},
            {"zin": "Questa strada porta a un grande portone, un ___. (porta)", "antwoord": "portone", "type": ":arrow_up:"},
            {"zin": "Che piatto enorme! Questo è un ___! (piatto)", "antwoord": "piattone", "type": ":arrow_up:"},
            {"zin": "Ho letto un piccolo libro illustrato, un ___. (libro)", "antwoord": "libricino", "type": ":arrow_down:"},
            {"zin": "Hai preparato una torta piccola ma deliziosa, una ___. (torta)", "antwoord": "tortina", "type": ":arrow_down:"},
            {"zin": "Non essere così ___, su! (cattivo)", "antwoord": "cattivello", "type": ":arrow_down:"},
            {"zin": "Ti mando un grande bacio, un ___! (bacio)", "antwoord": "bacione", "type": ":arrow_up:"},
            {"zin": "Era una donna davvero imponente, una ___. (donna)", "antwoord": "donnona", "type": ":arrow_up:"},
            {"zin": "Quel ragazzo è ___! Davvero, sa tutto. (intelligente)", "antwoord": "superintelligente", "type": ":arrow_up:"},
            {"zin": "Questa è un'informazione molto piccola e poco importante, un'___. (informazione)", "antwoord": "informazioncella", "type": ":arrow_down:"},
            {"zin": "Non è un evento ordinario, è qualcosa di ___. (ordinario)", "antwoord": "straordinario", "type": ":arrow_up:"},
            {"zin": "Abbiamo camminato per un piccolo tratto, un ___. (tratto)", "antwoord": "trattino", "type": ":arrow_down:"},
            {"zin": "Quello è un ___ di uomo! (uomo)", "antwoord": "omone", "type": ":arrow_up:"},
            {"zin": "Abbiamo preso un ___ prima di cena. (aperitivo)", "antwoord": "aperitivino", "type": ":arrow_down:"},
            {"zin": "Mi ha raccontato una ___ davvero interessante. (storia)", "antwoord": "storiella", "type": ":arrow_down:"},
            {"zin": "Quella pizza era enorme, un vero ___. (pizza)", "antwoord": "pizzone", "type": ":arrow_up:"},
            {"zin": "Vorrei un pezzetto piccolo, un ___. (pezzo)", "antwoord": "pezzettino", "type": ":arrow_down:"},
            {"zin": "Abbiamo bevuto un bicchiere piccolo, un ___. (bicchiere)", "antwoord": "bicchierino", "type": ":arrow_down:"},
            {"zin": "Quel cane era minuscolo, proprio un ___. (cane)", "antwoord": "cagnolino", "type": ":arrow_down:"},
            {"zin": "Questo libro è gigantesco, un ___! (libro)", "antwoord": "librone", "type": ":arrow_up:"},
    ...
    async def start_tra_quiz(self, message):
        ...
        await self.start_quiz(message.author, self.tra_zinnen, "antwoord", "!tra-soluzioni", intro, check_func=self.check_tra_risposta)
